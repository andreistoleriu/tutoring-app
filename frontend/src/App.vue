<template>
  <div id="app">
        ...
        <div class="flex justify-between items-center h-16">
          ...
          <nav class="hidden md:flex items-center space-x-6">
            <router-link to="/tutors"
              class="text-gray-600 hover:text-gray-900 font-medium transition-colors">Tutori</router-link>
            <a href="#materii" class="text-gray-600 hover:text-gray-900 font-medium transition-colors">Materii</a>
            <a href="#cum-functioneaza" class="text-gray-600 hover:text-gray-900 font-medium transition-colors">Cum
              funcționează</a>
          ...
          <div class="flex items-center space-x-3">
            ...
            <template v-else>
              <!-- Dashboard Link -->
              <router-link :to="authStore.isTutor ? '/dashboard/tutor' : '/dashboard/student'"
                class="px-4 py-2 text-gray-700 hover:text-gray-900 font-medium transition-colors">
                Dashboard
              </router-link>
              ...
              <div class="relative" ref="userMenuRef">
                ...
                <div v-if="showUserMenu"
                  class="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-200 py-2 z-[60]">
                  <router-link :to="authStore.isTutor ? '/dashboard/tutor' : '/dashboard/student'"
    ...
    <!-- Auth Modals -->
    <LoginModal :is-open="showLoginModal" @close="showLoginModal = false" @switch-to-register="switchToRegister" />

    <RegisterModal :is-open="showRegisterModal" @close="showRegisterModal = false" @switch-to-login="switchToLogin" />
  </div>
</template>
